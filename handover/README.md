...
2. **Out-of-scope approval records** — written approvals from Piranav that authorise piranav to act outside `piranav_aios` for a specific, bounded purpose
...
## Approved By
Piranav (record the exact instruction received)
...
1. Piranav to respond to remote repo name question (see README.md)
...
- Out-of-scope approval mechanism depends on Piranav being reachable — if Piranav is unavailable, the action must wait
