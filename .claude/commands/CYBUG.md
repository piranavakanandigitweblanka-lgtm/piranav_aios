...
## Step 3 — Check open items
Read `closure/README.md`. Report any sessions marked OPEN or FAIL that need follow-up.

## Step 4 — Git status check
Run `git status`. Report:
- Any untracked AIOS files (capability, closure, evidence, validation)
- Any uncommitted changes
- Current branch

## Step 5 — Report and stand by
After completing steps 1–4, give a short summary:
- Open items from closure (if any)
- Untracked/uncommitted files (if any)
- Any blockers
