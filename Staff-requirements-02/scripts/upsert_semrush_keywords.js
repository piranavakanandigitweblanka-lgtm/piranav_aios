...
// Use @neondatabase/serverless HTTP fetch mode (no WebSocket, no port 5432)
// neonConfig.fetchEndpoint defaults to the HTTP SQL API on port 443
const { neon } = require('../node_modules/@neondatabase/serverless');

// Honour the HTTPS proxy set in this environment
process.env.NODE_TLS_REJECT_UNAUTHORIZED = '0'; // handled by proxy CA
...
// Raw SEMrush data (semicolon-delimited, first line is header)
...
e27 bulb;6;6;18100;0.28;https://ledsone.co.uk/blogs/new/e27-bulb-guide;434;16.00;1
wire connectors;3;3;4400;0.27;https://ledsone.co.uk/collections/wire-connectors;286;23.00;1
intitle:ledsone;1;1;170;1.77;https://ledsone.co.uk/;136;37.00;2
...
b22 bulb;8;8;4400;0.31;https://ledsone.co.uk/blogs/new/b22-bayonet-bulbs-explained-your-essential-led-buying-guide;57;19.00;1
...
white blackboard;9;9;3600;0.61;https://ledsone.co.uk/collections/white-board;46;26.00;1
...
lamp shade holder;2;2;320;0.20;https://ledsone.co.uk/products/screw-e27-plain-holder-white-with-ring-bakelite-lamp-holder;42;8.00;1
...
plug in hanging pendant lamp;4;4;1300;0.32;https://ledsone.co.uk/collections/plugin-lighting;39;10.00;1
spider light;3;3;880;0.45;https://ledsone.co.uk/collections/spider-light;38;7.00;1,3
...
wall lights;28;28;40500;0.42;https://ledsone.co.uk/collections/wall-light;28;28.00;1
cage light shade;1;1;210;0.26;https://ledsone.co.uk/collections/wire-cage-pendant-light;27;16.00;1,3
white board white;21;21;18100;0.94;https://ledsone.co.uk/collections/white-board;27;24.00;1
e27 bulb;17;17;18100;0.28;https://ledsone.co.uk/collections/e27-base-bulb;27;16.00;1
...
ceiling rose;23;23;14800;0.65;https://ledsone.co.uk/collections/all-ceiling-rose;22;23.00;1
...
pendant light;22;22;12100;0.53;https://ledsone.co.uk/collections/plugin-lighting;18;24.00;1
...
pendant light with plug in;2;2;210;0.32;https://ledsone.co.uk/collections/plugin-lighting;17;7.00;0
...
shower curtain;33;33;22200;0.29;https://ledsone.co.uk/collections/shower-curtain;15;33.00;1
...
edison screw bulb;8;0;1600;0.34;https://ledsone.co.uk/blogs/new/e27-bulb-guide;14;13.00;1
light shades;21;21;9900;0.25;https://ledsone.co.uk/collections/lighting-shades;14;28.00;1
...
tape;25;25;9900;2.08;https://ledsone.co.uk/collections/tapes;14;44.00;1
...
shower curtain mould proof;3;3;170;0.27;https://ledsone.co.uk/products/fabric-solid-color-shower-curtain-for-bathtub-shower-5288;13;20.00;0,1
...
hanging from chains;7;7;480;0.00;https://ledsone.co.uk/collections/cord-grip-and-hanging-chains;11;23.00;1
...
power adapter dc 12v;2;2;170;0.31;https://ledsone.co.uk/products/12v-10a-power-supply-adapter-transformer;11;21.00;1
...
light with plug in;4;4;390;0.23;https://ledsone.co.uk/collections/plugin-lighting;11;7.00;0
lampshade pendant lighting;14;14;2900;0.28;https://ledsone.co.uk/pages/lamp-shades-for-pendant-table-floor-lights;11;18.00;0
3 core wire;5;5;390;0.20;https://ledsone.co.uk/blogs/new/understanding-3-core-electrical-cables-types-uses-and-color-codes;11;12.00;1`;

async function main() {
  let sql;
  try {
    sql = neon(CONNECTION_STRING);
    console.log('Neon HTTP client created');
  } catch (e) {
    console.error('Failed to create neon client:', e.message);
    process.exit(1);
  }
  ...
  try {
    ...
    for (const line of dataLines) {
      ...
      const pos = parseInt(position, 10) || null;
      const prev_pos = parseInt(prev_position, 10) || null;
      const vol = parseInt(volume, 10) || null;
      const cpc_val = parseFloat(cpc) || null;
      const traf = parseInt(traffic, 10) || null;
      const kd = parseFloat(keyword_difficulty) || null;
      ...
      await sql`
        ...
        VALUES (${snapshot_date}, ${keyword.trim()}, ${pos}, ${prev_pos}, ${vol}, ${cpc_val}, ${url.trim()}, ${traf}, ${kd}, ${intent.trim()})
