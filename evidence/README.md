...
| 2026-06-29 | IMAGE-FIX-001 — Variant image display fix (PDP images not showing) | Evidence markdown | `evidence/shopify/product-image-fixes/shopify_variant_image_display_fix_2026-06-29.md` | PASS — fix documented, product URL + ID + before/after screenshots all recorded |
